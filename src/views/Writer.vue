<template>
  <div id="writer">
    ...
    <div class="modal-inner" v-show="modalPop">
      <div class="modal-title" v-if="!editModal">Add Writer</div>
      <div class="modal-title" v-else>Edit Writer</div>
  ...
  methods: {
    ...
    getUserData() {
      axios
        ...
        .then((res) => {
          const newUser = res.data.userData.filter((user) => user.type == 0);
          this.users = newUser;
        });
    },
